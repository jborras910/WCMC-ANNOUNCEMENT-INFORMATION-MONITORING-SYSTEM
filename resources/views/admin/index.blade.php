...
<head>
  ...
  <style>
    ...
    /* ── Base ── */
    body { font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif !important; color: var(--text); background: var(--bg) !important; }

    /* ── Cards ── */
    .card { border: none !important; border-radius: var(--radius) !important; box-shadow: 0 1px 4px rgba(0,0,0,0.07) !important; }
    .card-body { padding: 24px !important; }

    /* ── Page header (form pages) ── */
    .page-card { border-radius: var(--radius); overflow: hidden; box-shadow: 0 1px 4px rgba(0,0,0,0.07); background: #fff; }
    .page-card-header {
      padding: 18px 24px;
      border-bottom: 1px solid var(--border);
      display: flex; align-items: center; justify-content: space-between;
    }
    .page-card-header h5 { margin: 0; font-weight: 700; font-size: 15px; color: var(--text); }
    .page-card-body { padding: 28px 24px; }
    ...
    .btn .mdi, .btn [class^="mdi-"], .btn [class*=" mdi-"],
    .btn .fa,  .btn [class^="fa-"],  .btn [class*=" fa-"] {
      vertical-align: middle;
      position: relative;
      top: -1px;
      line-height: 1;
    ...
    /* Sidebar menu icons */
    .sidebar .menu-icon { vertical-align: middle; top: 0 !important; }
    ...
    .btn .mdi, .btn .fa { top: 0 !important; }
    /* Normalize button group alignment */
    .btn + .btn, .btn + a.btn, a.btn + .btn { margin-left: 0; }
    ...
    /* ── Status badges ── */
    .badge-pill-status { display:inline-block;padding:4px 14px;border-radius:20px;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.04em; }
    ...
    /* ── Sidebar ── */
    .sidebar .nav-item.active > .nav-link { background:rgba(255,255,255,0.15);border-radius:5px; }
    .sidebar .nav-item > .nav-link { transition:background 0.18s ease;border-radius:5px; }
    .sidebar .nav-item > .nav-link:hover { background:rgba(255,255,255,0.09); }
    ...
    .dataTables_info { font-size: 12px; color: var(--text-muted); }

    /* ── Table ── */
    .table th { font-size: 11.5px !important; font-weight: 700 !important; text-transform: uppercase !important; letter-spacing: 0.05em !important; color: var(--text-muted) !important; }
    ...
    .navbar .nav-profile .nav-link { cursor: pointer; }

    /* ── Loader ── */
    #page-loader { position:fixed;inset:0;background:#fff;z-index:9999;display:flex;flex-direction:column;align-items:center;justify-content:center;transition:opacity 0.3s ease; }
    .loader-ring { width:44px;height:44px;border:4px solid #e8eaf6;border-top-color:var(--primary);border-radius:50%;animation:spin 0.7s linear infinite; }
    .loader-text { margin-top:12px;font-size:12px;color:#9e9e9e;letter-spacing:0.04em; }
  ...
  <style>
    ...
    .stat-card .stat-icon { font-size: 2.2rem; opacity: 0.25; }
    ...
    .s-published{ background: #d1e7dd; color: #0a5c36; }
    .s-rejected { background: #f8d7da; color: #842029; }

    /* ── Table row tightness ── */
    #dataTable td { vertical-align: middle; padding: 10px 14px !important; }
    #dataTable th { padding: 10px 14px !important; }
  </style>
</head>
<body>
      ...
      <div class="navbar-brand-wrapper d-flex justify-content-center align-items-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand brand-logo">
            <img style="width:70%;height:auto;" src="https://www.worldcitimedicalcenter.com/frontend/wcmc-logo.png" alt="WCMC" />
          </a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item {{ request()->routeIs('admin.users') || request()->routeIs('admin.addUser') ? 'active' : '' }}">
